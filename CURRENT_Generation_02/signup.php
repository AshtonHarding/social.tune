...
<div id="wrap">
	...
	<div class="jumbotron">
		<div class="row">
			...
			<div class="col-md-4">
				...
				<form method="POST" action="register.php">
					...
					<div class="form-group">
						<div class="col-xs-12">
							<center><h2>Birthdate</h2></center>
						</div>
						<div class="col-xs-4"> <!--// Month //-->
							<select class="form-control" style="font-size:12px;" name="month">
								<option>Month</option>
								<?php /* Consider changing to date names and do a bunch of if-statements to convert "Jan -> 01" etc. */
								$month = 01;
								while($month <= 12){
			...
			<br />
			<p style="font-size: 8px;">Are you a <a href="band-signup.php">band</a>?</p>
		...
		<?php // if the email is already in use.
			...
			if($inUse == 2){
				echo '<center><h2>You forgot to fill something in.</h2></center>';
			}
